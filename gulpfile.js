...
gulp.task('vendors', function () {
  ...
  vendorJs.push('bower_components/ace-builds/src-min-noconflict/ace.js');
  vendorJs.push('bower_components/ace-builds/src-min-noconflict/mode-javascript.js');
  if (vendorJs.length) {
...
gulp.task('index', ['app-html'], index);
 ...
 * Dist
 */
gulp.task('dist', ['vendors', 'assets', 'chrome','styles-dist', 'scripts-dist', 'index-dist']);
...
function templateFiles (opt) {
  return gulp.src(['./src/app/**/*.html', '!./src/app/index.html', '!./src/app/app.html', '!./src/app/assets/comps/**/*.html'], opt)
